...
function Tree(opts) {
    ...
    this.height = opts.height || 700 - this.margin.top - this.margin.bottom;
...
var Tree = require("{{ url_for ('static', filename='components/js/plugins/tubiao/d3-collapsible-tree.js') }}");

var el = document.getElementById('categoryHierarchy');
...
tree.getData('/server/contactapi/' + suffix);

},{"{{ url_for ('static', filename='components/js/plugins/tubiao/d3-collapsible-tree.js') }}":1}]},{},[3]);